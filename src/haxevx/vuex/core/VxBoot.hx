...
class VxBoot
{
	...
	public function startVueWithRootComponent<T>(el:String, rootComponent:VComponent<Dynamic, Dynamic>, ?params: Dynamic):Vue {
		var bootVueParams : Dynamic = params == null ? {} : params;
